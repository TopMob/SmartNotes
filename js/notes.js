...
function renderNotes(list) {
    ...
    grid.innerHTML = list.map(n => {
        ...
        const favoriteLabel = UI.getText("favorite_note", "Favorite")
        ...
        return `
            <div class="note-card ${pinCls}" draggable="true" data-note-id="${encodeURIComponent(n.id)}">
                <div class="card-actions">
                    <button type="button" class="action-btn" aria-label="${Utils.escapeHtml(pinLabel)}" data-action="pin-note" data-id="${encodeURIComponent(n.id)}"><i class="material-icons-round" aria-hidden="true">push_pin</i></button>
                    <button type="button" class="action-btn" aria-label="${Utils.escapeHtml(favoriteLabel)}" data-action="favorite-note" data-id="${encodeURIComponent(n.id)}"><i class="material-icons-round" aria-hidden="true">star</i></button>
                    <button type="button" class="action-btn" aria-label="${Utils.escapeHtml(menuLabel)}" data-action="note-actions" data-id="${encodeURIComponent(n.id)}"><i class="material-icons-round" aria-hidden="true">more_horiz</i></button>
                </div>
